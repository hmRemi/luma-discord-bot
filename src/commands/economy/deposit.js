...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addIntegerOption((option) =>
            option
            .setName('amount')
            .setDescription('Specify the amount of money you want to deposit')
            .setRequired(true)
        ),
    async execute(interaction) {
        ...
        if (!profile.length) {
            ...
            if(amount > profile[0].Wallet) {
                await interaction.reply({
                    embeds: [
                        Embed.setDescription("You don't have enough money in your wallet.")
                    ]
                });
            } else {
                ...
                await interaction.reply({
                    embeds: [
                        Embed.setDescription("You have successfully deposited $" + amount + " into your bank.")
                    ]
                });
            }
        }
