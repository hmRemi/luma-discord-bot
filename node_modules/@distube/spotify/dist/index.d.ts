...
import type { CustomPluginPlayOptions, SearchResult } from "distube";
...
export declare class SpotifyPlugin extends CustomPlugin {
    parallel: boolean;
    emitEventsAfterFetching: boolean;
    constructor(options?: SpotifyPluginOptions);
    validate(url: string): Promise<boolean>;
    play(voiceChannel: VoiceBasedChannel, url: string, options: CustomPluginPlayOptions): Promise<void>;
